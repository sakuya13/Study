A sample solution to "Slot".

Well, the question is a bit like using State monads for the sake of 
using State monads, so ... ehm.

But exercise questions are always like that, aren't they?
